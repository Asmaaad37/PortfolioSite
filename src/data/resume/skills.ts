...
const skills: Skill[] = [
  ...
  },
  {
    title: 'FastAPI',
    competency: 4,
    category: ['LLM & AI Engineering', 'Web Development'],
  },
  // Data Engineering
  {
    title: 'Pandas',
  ...
  {
    title: 'GCP (BigQuery, Mage)',
    competency: 3,
    category: ['Data Engineering', 'Deployment & Infra'],
  },
  {
    title: 'pgvector',
    competency: 3,
    category: ['Data Engineering', 'LLM & AI Engineering'],
  },
  // Deployment & Infra
  {
    title: 'REST APIs',
